<?php
   ...
   class PromoCodeController extends Controller
   {
      ...
      public function index()
      {
         ...
         $PromoCodes = PromoCode::where('vendor_id', $vendor->id)->orderBy('id','DESC')->get();
         return view('vendor.promo code.promo_code',compact('PromoCodes'));
      }
...
//         $vendors = Vendor::get();
         ...
         return view('vendor.promo code.create_promo_code',compact('vendors','users'));
      }
      ...
      public function store(Request $request)
      {
         ...
         return redirect('vendor/promo_code')->with('msg','promo code created successfully..!!');
      }
...
//         $vendors = Vendor::get();
         ...
         return view('vendor.promo code.edit_promo_code',compact('promoCode','vendors','users'));
      }
      ...
      public function update(Request $request, PromoCode $promoCode)
      {
         $request->validate([
             'name' => 'required',
             'promo_code' => 'required',
             'discount' => 'required_if:isFlat,0',
             'discountType' => 'required_if:isFlat,0',
             'max_disc_amount' => 'required_if:isFlat,0',
         ...
         return redirect('vendor/promo_code')->with('msg','promo code updated successfully..!!');
      }
