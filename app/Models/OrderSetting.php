...
class OrderSetting extends Model
{
    ...
    protected $fillable = ['vendor_id','free_delivery','free_delivery_distance','free_delivery_amount','min_order_value',  'order_commission','order_assign_manually','orderRefresh','order_dashboard_default_time','vendor_order_max_time','driver_order_max_time','delivery_charge_type','charges','delivery_charge_type'];
}
