...
//Vendor
   ...
   Route::middleware(['auth'])->prefix('vendor')->group(function () {
      ...
      // add_user
      Route::get('get-order-notificati  on',[BusinessSettingController::class,'getNodification'])->name('vendor.get-order-notification');
      Route::get('get-order-list',[BusinessSettingController::class,'getOrderList'])->name('vendor.order.list');
   ...
   Route::middleware(['auth'])->prefix('customer')->name('customer.')->group(function () {
      ...
      Route::post('/get-halfMenuSize', [App\Http\Controllers\Customer\OrderController::class, 'halfMenuSize']);
