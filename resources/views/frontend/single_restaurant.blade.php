@extends('frontend.layouts.app_restaurant',['activePage' => $rest->name])
        ...
        <div class="row">
            ...
            <div class="col-lg-3" id="sidebar">
                <div class="theiaStickySidebar">
                    ...
                    @include('frontend.layouts.cart', ['page' => route('customer.restaurant.order.first.index')])
