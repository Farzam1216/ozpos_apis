    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ url('admin/vendor/'.$menu->vendor_id)}}">{{App\Models\Vendor::find($menu->vendor_id)->name}}</a></div>
            ...
            <form class="container-fuild" action="{{ url('admin/submenu') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('price') is-invalid @enderror" name="price" type="number"  min=1 placeholder="{{__('Item Price')}}" required value="{{ old('price') }}">
        ...
        <div class="modal-content">
            <form id="update_submenu_form" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-control-label">{{__('Item price')}}<span class="text-danger">&nbsp;*</span></label>
                        <input class="form-control @error('price') is-invalid @enderror" name="price" type="number" min=1 placeholder="{{__('Item Price')}}" id="update_price" required value="{{ old('price') }}" style="text-transform: none">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{url('admin/submenu_import/'.$menu->vendor_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
