                                                        ...
                                                        <tbody id="{{'custom'.$custimization_type->id}}">
                                                            ...
                                                            @if ($items)
                                                                @foreach ($items as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="number" min=1 name="price[]" value="{{ $item->price }}" placeholder="{{__('Price')}}" class="form-control">
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            @else
                                                                <tr id="{{'custom'.$custimization_type->id}}">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min=1 required name="price[]" placeholder="{{__('Price')}}" class="form-control">
                                                                    </td>
                                                                    <td>
