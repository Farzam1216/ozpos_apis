...
<div class="login-page vh-100">
    ...
    <div class="row d-flex">
        <div class="col-md-6 ml-auto">
            <div class="login-page vh-100">
                <input id="pac-input" class="form-control" type="text" placeholder="Enter your location or drag marker"
                    style="margin: 10px 4%;" required>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('customer.delivery.location.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-white" id="address"
                                                name="address" placeholder="Selected address" readonly="readonly"
                                                required>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <label><input name="term" type="checkbox" value="" class="icheck"
                                                checked>Accept <a href="#0">terms and conditions</a>.</label>
                                    </div>
                                </div><!-- End row  -->
