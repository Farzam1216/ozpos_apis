    ...
    <span ><h2 class="font-weight-bold">{{ $rest->name }}</h2>
      <p class="text-white m-0">{{ $rest->address }}</p> </span>
        ...
        <a class="carousel-control-contact">
            ...
            <p class="font-weight-bold contacts"> <i class="feather-phone-call"></i>
                {{ $rest->contact ?? 'no number yet' }}<br>
                    ...
                    <div class="cat-item px-1 py-3">
                        @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                            <a class="bg-white rounded d-block p-2 text-center shadow-sm"
                                href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list">
                        ...
                        @else
                            <a class="bg-white rounded d-block p-2 text-center shadow-sm"
                                href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}">
                                <img alt="#" src="{{ asset($item->image) }}" style="height:35px" class="img-fluid mb-2">
                                <p class="m-0 small">{{ $item->name }}</p>
                            </a>
                        @endif
            ...
            <div class="pt-4 pb-2 title d-flex align-items-center">
                ...
                @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                    <a href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list"
                        class="font-weight-bold ml-auto text-white btn bg-primary m-none">
                                    ...
                                    @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                        <a
                                            ...
                                            <img alt="#" src="{{ asset($value->image) }}"
                                                class="img-fluid item-img w-100" style="height: 40%;">
                                        </a>
                                    @else
                                        <a href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}">
                                            <img alt="#" src="{{ asset($value->image) }}"
                                ...
                                <div class="p-3 position-relative">
                                    <div class="list-card-body">
                                        <h6 class="mb-1">
                                            @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                                <a href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list"
                                                    class="text-black"><strong>{{ ucwords($value->name) }} </strong>
                                                </a>
                                            @else
                                                <a href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}"
                                                    class="text-black"><strong>{{ ucwords($value->name) }} </strong>
                                    ...
                                    <div class="list-card-badge">
                                        ...
                                        </span> <small class="badge badge-success">
                                            {{ $value->display_discount_price }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="p-3 position-relative">
                                        <div class="list-card-body">
                                            <h6 class="mb-1">
                                                @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                                    <a href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list"
                                                        class="text-black"><strong>{{ ucwords($value->name) }}
                                                        </strong>
                                                    </a>
                                                @else
                                                    <a href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}"
                                    ...
                                    <div class="list-card bg-white  rounded overflow-hidden position-relative shadow-sm">
                                        <div class="list-card-image">
                                            ...
                                            @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                                <a
                                                    href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list">
                                                    <img alt="#" src="{{ asset($halfmenu->image) }}"
                                                        class="img-fluid item-img w-100" style="height: 60%;">
                                                </a>
                                            @else
                                                <a href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}">
                                                    <img alt="#" src="{{ asset($halfmenu->image) }}"
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                ...
                                                <h6 class="mb-1">
                                                    @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                                        <a href="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/list"
                                                            class="text-black"><b> {{ ucwords($halfmenu->name) }}</b>
                                                        </a>
                                                    @else
                                                        <a href="{{ url('customer/restaurant/' . $vendor_id . '/menu') }}"
                                                            class="text-black"><b> {{ ucwords($halfmenu->name) }}</b>
