{{-- @section('custom_modals') --}}
   {{-- <div class="modal fade" id="HalfMenuAddon-{{ $prefix }}-{{ $HalfNHalfMenu->id }}-{{ $ItemSize }}-{{ $Menu->id }}" tabindex="-1" role="dialog" aria-labelledby="HalfMenuAddonModal-{{ $prefix }}-{{ $HalfNHalfMenu->id }}-{{ $ItemSize }}-{{ $Menu->id }}" aria-hidden="true" style="z-index: 1060">
         ...
         <div class="modal-content"> --}}
            ...
            <div class="modal-footer p-0 border-0">
               <div class="col-12 m-0 p-0">
                  <button id="HalfMenu-{{ $prefix }}-{{ $HalfNHalfMenu->id }}-{{ $ItemSize }}-{{ $Menu->id }}" type="button" class="btn btn-primary btn-lg btn-block" data-dismiss="modal">
                     Pick
                  </button>
               </div>
            </div>
