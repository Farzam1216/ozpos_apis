                    ...
                    <div class="rounded shadow-sm p-4 bg-white">
                        ...
                        <div id="edit_profile">
                            <div>
                                @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                    <form
                                        action="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/single-profile-update/{{ $user->id }}"
                                        method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="exampleInputName1d"
                                        value="{{ $user->name }}">
                                </div>
                                @php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control" name="phone_code" id="exampleInputName1"
                                        value="{{ $data[1] }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputNumber1">Mobile Number</label>
                                    <input type="number" class="form-control" name="phone" id="exampleInputNumber1"
                                        value="{{ $user->phone }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="additional">
                                <div class="change_password my-3">
                                    @if (isset($_SERVER['HTTP_X_FORWARDED_HOST']))
                                        <form
                                            action="{{ isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' }}://{{ $_SERVER['HTTP_X_FORWARDED_HOST'] }}/single-change-password/{{ $user->id }}"
                                            method="POST">
                                            {{-- <form action="{{route('customer.profile.update',$user->id)}}" method="POST"> --}}
                                        @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('new_confirm_password'))
                                            <div class="error text-danger">{{ $errors->first('new_confirm_password') }}
                                            </div>
                                        @endif
                                    </div>
                                    <div class="text-center">
