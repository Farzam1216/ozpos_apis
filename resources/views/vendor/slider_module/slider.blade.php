...
@extends('layouts.app',['activePage' => 'vendor_slider'])
...
@section('content')
   ...
   <section class="section">
      ...
      <div class="section-body">
         ...
         {{--         <p class="section-lead">{{__('Add, and categorize the slider adding sub-sliders. (Add,Edit & Manage Slider Categories )')}}</p>--}}
         <div class="card">
               ...
               <table id="datatable" class="table table-striped table-bordered text-center" cellspacing="0" width="100%">
                  ...
                  @foreach ($Slider as $idx=>$item)
                     <tr>
                        ...
                        <td>
                           <button type="button" onclick="updateData('vendor/slider',{{$item->id}})" class="btn btn-primary" data-toggle="modal" data-target="#edit_modal">
                              <i class="fas fa-pencil-alt"></i>
                           </button>
                           <a href="javascript:void(0);" class="table-action btn btn-danger btn-action" onclick="deleteData('vendor/slider',{{ $item->id }},'{{ $title }}')">
            ...
            <div class="card-footer">
               <input type="button" value="Delete selected" onclick="deleteSelectionData('vendor/slider/selection_destroy','{{ $title }}')" class="btn btn-primary">
            </div>
         </div>
      </div>
   ...
   <div class="modal right fade" id="insert_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <form class="container-fuild" action="{{ url('vendor/slider') }}" method="post" enctype="multipart/form-data">
               @csrf
