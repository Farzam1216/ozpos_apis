    ...
    <div class="section-body">
      ...
      <div class="card">
            ...
            @foreach ($Menu as $idx=>$item)
              <tr>
                ...
                <td>
                  ...
                  <a href="javascript:void(0);" class="table-action btn btn-danger btn-action" onclick="deleteData('vendor/menu',{{ $item->id }},'{{ $title }}')">
                    <i class="fas fa-trash"></i> </a>

                  @if($item->price === null)
                    <a href="{{ url('vendor/menu_size/'.$item->id) }}" class="btn btn-warning btn-action mr-1" data-toggle="tooltip" data-original-title="Menu Sizes">
                      <i class="fas fa-boxes"></i>
                    </a>
                  @else
                    <a href="{{ url('vendor/menu_addon/'.$item->id) }}" class="btn btn-info btn-action mr-1" data-toggle="tooltip" data-original-title="Menu Addons">
        ...
        <div class="card-footer">
          <input type="button" value="Delete selected" onclick="deleteSelectionData('vendor/menu/selection_destroy','{{ $title }}')" class="btn btn-primary">
        </div>
      </div>
    </div>
  ...
  <div class="modal right fade" id="insert_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form class="container-fuild" action="{{ url('vendor/menu') }}" method="post" enctype="multipart/form-data">
          @csrf
