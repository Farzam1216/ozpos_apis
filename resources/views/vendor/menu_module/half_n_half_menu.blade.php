         ...
         <div class="card">
            ...
            <div class="card-body">
               <table id="datatable" class="table table-striped table-bordered text-center" cellspacing="0" width="100%">
                  ...
                  <tbody>
                  @foreach ($HalfNHalfMenu as $idx=>$item)
                     <tr>
                        <td>
                        ...
                        <td>
                           <button type="button" onclick="updateData('vendor/half_n_half_menu',{{$item->id}})" class="btn btn-primary" data-toggle="modal" data-target="#edit_modal">
                              <i class="fas fa-pencil-alt"></i>
                           </button>
                           <a href="javascript:void(0);" class="table-action btn btn-danger btn-action" onclick="deleteData('vendor/half_n_half_menu',{{ $item->id }},'{{ $title }}')">
            ...
            <div class="card-footer">
               <input type="button" value="Delete selected" onclick="deleteSelectionData('vendor/half_n_half_menu/selection_destroy','{{ $title }}')" class="btn btn-primary">
            </div>
         </div>
      </div>
   ...
   <div class="modal right fade" id="insert_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <form class="container-fuild" action="{{ url('vendor/half_n_half_menu') }}" method="post" enctype="multipart/form-data">
               @csrf
