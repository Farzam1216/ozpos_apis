    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header">
                <div class="w-100">
                    <a href="{{ url('vendor/vendoruser/create') }}" class="btn btn-primary float-right">{{__('Add New')}}</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td class="d-flex">
                                        <a href="{{ url('vendor/vendoruser/'.$user->id.'/edit') }}" class="btn btn-primary btn-action mr-1 {{ $user->id == 1 ? 'disabled' : '' }}" data-toggle="tooltip" title="" data-original-title="{{__('Edit user')}}"><i class="fas fa-pencil-alt"></i></a>

                                        <a href="{{ url('vendor/vendoruser/'.$user->id) }}" data-toggle="tooltip" title="" data-original-title="{{__('show user profile')}}" class="btn btn-primary btn-action mr-1 {{ $user->id == 1 ? 'disabled' : '' }}"><i class="fas fa-eye"></i></a>
