          ...
          <div class="card-body p-5">
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <select name="connector_type" class="form-control @error('connector_type') is_invalide @enderror">
                  <option
                    value="windows" {{ $vendor->connector_type == 'windows' ? 'selected' : '' }}>{{__('windows')}}</option>
                  <option value="cups" {{ $vendor->connector_type == 'cups' ? 'selected' : '' }}>{{__('cups')}}</option>
                  <option
                    value="network" {{ $vendor->connector_type == 'network' ? 'selected' : '' }}>{{__('network')}}</option>
                </select>
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text" name="connector_descriptor" required
                       class="form-control @error('connector_descriptor') is_invalide @enderror"
                       placeholder="{{__('Connector Descriptor')}}" value="{{$vendor->connector_descriptor}}">
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text" name="connector_port"
                       class="form-control @error('connector_port') is_invalide @enderror"
                       placeholder="{{__('Connector Port')}}" value="{{$vendor->connector_port}}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            if your connector_type is network Set connector_port to the open port for the printer, only if your
            connector_type is network
          </div>
        </div>
