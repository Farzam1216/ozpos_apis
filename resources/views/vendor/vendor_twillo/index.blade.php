...
@section('title','Vendor Twilio Setting')
...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ url('vendor/save_twillio') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h4>{{__('Twillio setting')}}</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="vendorstatus" @if($twillio) {{ $twillio->vendorstatus == 1 ? 'checked' : '' }} @endif>
                            ...
                            <div class="col-md-4">
                                ...
                                <label class="switch">
                                    <input type="checkbox"  @if($twillio)

                                    {{ $twillio->email == 1 ? 'checked' : '' }} @endif  name="email">
                                    <div class="slider"></div>
                                </label>
                            </div>
                            <div class="col-md-4">
                                ...
                                <label class="switch">
                                    ...
                                    {{ $twillio->sms == 1 ? 'checked' : '' }} @endif  name="sms" >
                                    <div class="slider"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input required type="text" @if($twillio)
                                   value="{{ $twillio->sid }}"
                                   @endif name="sid" id="twilio_acc_id" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" @if($twillio) value="{{ $twillio->token }}" @endif name="token" id="twilio_auth_token" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" @if($twillio) value="{{ $twillio->number }}" @endif name="number" id="twilio_phone_no" required class="form-control">
                            </div>
                        </div>
