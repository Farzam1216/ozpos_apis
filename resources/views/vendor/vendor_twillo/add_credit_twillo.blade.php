@extends('layouts.app',['activePage' => 'twillo'])

@section('title','mobile sms')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{__('Vendor Mobile SMS')}}</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">{{__("Credits For Mobile SMS")}}</h2>
            <p class="section-lead">{{__('Purchase and Manage the credits')}}</p>
            <div class="card">
                <form action="{{ url('vendor/add_vendor_bank_details') }}" method="post">
                    @csrf
