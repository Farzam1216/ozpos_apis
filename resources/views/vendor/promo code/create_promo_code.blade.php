...
@section('content')
  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-body">
          <form class="container-fuild" action="{{ url('vendor/promo_code') }}" method="post"
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                ...
                <div class="fileContainer sprite">
                  <span>{{__('Image')}}</span>
                  <input type="file" name="image" accept=".jpg,.png,.jpeg" value="Choose File" id="previewImage"
                         dataid="add" accept=".png, .jpg, .jpeg, .svg">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-5">
                ...
                <input type="text" name="name" class="form-control @error('name') is_invalide @enderror"
                       placeholder="{{__('Promo Code Name')}}" value="{{old('name')}}" required="">
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-5 discountType">
                <label for="{{__('Discount type')}}">{{__('Discount type')}}<span
                    class="text-danger">&nbsp;*</span></label>
              ...
              <div class="col-md-3 mb-5 max_disc_amount">
                ...
                <input type="number" name="discount" min=1 class="form-control" placeholder="{{__('Enter Discount')}}"
                       value="{{ old('discount') }}">
              </div>

              <div class="col-md-6 mb-5 hide flatDiscount" style="display: none;">
                <label for="{{__('Flat Discount')}}">{{__('Flat Discount')}}</label>
                <input type="number" min=1 name="flatDiscount"
                       class="form-control @error('flatDiscount') is_invalide @enderror" id="flatDiscount"
                       placeholder="{{__('Enter Flat Discount In Amount')}}" value="{{ old('flatDiscount') }}">
              </div>
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <label for="{{__('Maximum Discount amount')}}">{{__('Maximum Discount Amount')}}<span
                    class="text-danger">&nbsp;*</span></label>
            ...
            <div class="row">
              <div class="col-md-6 mb-5">
                <label for="{{__('Promo Code redeem start/end Period')}}">{{__('Promo Code Redeem Start/End Period')}}
            ...
            <div class="row">
              <div class="col-md-6 mb-5">
                ...
                <textarea name="description" class="form-control"
                          placeholder="{{__('Promo Code Description')}}">{{ old('description') }}</textarea>
              </div>
              <div class="col-md-6 mb-5">
                <label for="{{__('max_user')}}">{{__('Promo code display text')}}<span
                    class="text-danger">&nbsp;*</span></label>
                <textarea name="display_text" class="form-control"
                          placeholder="{{__('Promo Code Display Text')}}">{{ old('display_text') }}</textarea>
              </div>
            </div>
